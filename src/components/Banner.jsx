      ...
      <div className="py-20 flex flex-col md:flex-row-reverse justify-between items-center gap-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around -mt-14 gap-4">
          ...
          <div className="flex bg-white py-2 px-3 rounded-2xl items-center gap-3 shadow-md">
            <img
              src="/images/home/b_image1.png"
              alt=""
              className="w-[60px] h-[60px] rounded-2xl "
            />
            <div className="space-y-1">
              <h5 className="font-medium mb-1 text-Grey ">Chocolate Cake</h5>
          ...
          {/* other card */}
          <div className="sm:flex hidden bg-white py-2 px-3 rounded-2xl items-center gap-3 shadow-md">
            <img
              src="/images/home/b_image1.png"
              alt=""
              className="w-[60px] h-[60px] rounded-2xl "
